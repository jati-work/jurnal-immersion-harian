...
<div className="actions">
        ...
        <div style={{ position: 'relative', marginLeft: 'auto' }}>
          <button className="icon-btn" onClick={() => setShowMenu(m => !m)} title="Menu lainnya" style={{ width: 32, height: 32, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 14, letterSpacing: 1, lineHeight: 1 }}>···</button>
          {showMenu && (
            <div style={{
